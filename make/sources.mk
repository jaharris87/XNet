...
CONFIG_RECORD_VALUES := $(ROOT_DIR) $(PE_ENV) $(CMODE) $(MACHINE) $(MPI_MODE) $(OPENMP_MODE) \
  ...
  $(COMPILE_FFLAGS) $(XNET_CONTROLS_FFLAGS) $(COMPILE_F90FLAGS) $(F77FLAGS) \
  $(CPP_EFFECTIVE_FLAGS) $(LDFLAGS) \
...
CONFIG_RECORD_ARGUMENTS = \
  ...
  'FFLAGS=$(COMPILE_FFLAGS)' 'XNET_CONTROLS_FFLAGS=$(XNET_CONTROLS_FFLAGS)' \
  'F90FLAGS=$(COMPILE_F90FLAGS)' 'F77FLAGS=$(F77FLAGS)' \
