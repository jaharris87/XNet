...
This directory contains an unregistered configuration qualification for MPI
and OpenMP zone handling. It is not part of the ordinary physical regression list and stores no
