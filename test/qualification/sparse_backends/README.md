...
against the real library and reuse the tracked three-equation fixture. Base
...
licence. The recorded qualification used the archived Fortran 77 MA48 2.2.0
...
The recorded qualification uses oneMKL PARDISO, not the distinct
...
does not qualify the standalone ABI. Do not substitute the numerical test stub
or oneMKL library for a standalone qualification.
